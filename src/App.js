...
function App() {
  ...
  return (
    ...
    <div className="App" style={{ width: "96%", borderRadius: "10px", marginLeft: "auto", marginRight: "auto",  fontFamily: "SpaceMono-Regular"}}>
      ...
      <a  href="/sign_up" style={{paddingTop: "0.5%", paddingBottom: "0.5%", paddingLeft: "1%", paddingRight: "1%", fontWeight: "normal", fontSize: "100%", marginTop: "3%", float: "right", marginRight: "4%", borderRadius: "5px", borderStyle: "solid", borderColor: "transparent", backgroundColor: "#09E482", color: "black", textDecoration: "none"}} onClick={handlePageChange}>Sign Up</a>
      <h1 style={{marginTop: "15%", fontSize: "500%", float: "left", width: "50%", textAlign: "left", fontWeight: "normal", fontWeight: "600"}}>A social gym app that meets your logging needs</h1>
      <div style={{ float: "left", clear: "left", backgroundColor: "#121619", borderRadius: "10px", padding: "1% 2%", marginLeft: "11%", marginTop: "2%", marginBottom: "3%", display: "inline-block", whitespace: "nowrap", width: '30%'}}>
    ...
    <img src={appPage} width="20%" style={{float: "right", marginRight: "15%", marginTop: "-30%"}}></img>
